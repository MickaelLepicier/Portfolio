    ...
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[660px] flex flex-col">
      ...
      <div
        className="absolute 
                ...
                rounded-full             
                transform rotate-12
                shadow-[0_0_40px_rgb(255,165,0,0.4)] "
      ></div>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center relative">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              natus fuga error pariatur tempore, asperiores dolor quo facilis
              consequuntur expedita inventore. Blanditiis at quae eum minima
              perspiciatis, vel aut laudantium.
            </p>
