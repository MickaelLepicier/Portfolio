...
const listProjects = [
    {id:1, image: image, title:'Project 1', description:'Project 1 description bla bla'},
    {id:2, image: image2, title:'Project 2', description:'Project 2 description bla bla'},
    {id:3, image: image3, title:'Project 3', description:'Project 3 description bla bla'},
    {id:4, image: image3, title:'Project 4', description:'Project 4 description bla bla'},
]
                    ...
                    listProjects.map((project)=>{
                        ...
                        <div key={project.id} className='p-4'>
                            <div className='h-full border-2 border-orange-400 shadow-[0_0_15px_rgba(255,165,0,0.7)] border-opacity-60 rounded-lg overflow-hidden'>
                                ...
                                <div className='p-6'>
                                    <h2 className='tracking-widest text-xl title-font font-medium text-gray-400 md-1'>{project.title}</h2>
